...
def raw_to_wav(raw_filename, wav_filename, sample_rate=44100, bit_depth=16, channels=2):
...
# Example usage
raw_to_wav('RECORD.RAW', 'RECORD.wav', sample_rate=44100, bit_depth=16, channels=2)